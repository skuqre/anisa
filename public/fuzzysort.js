/*
DEV NOTE: I had to edit this a bit to get it working with the script tags.
It works now but I feel guilty embedding this library here
*/
...
//     'use strict'
    ...
    export var go = (search, targets, options) => {                                                                                                                                                                                                                  if(search=='farzher')return[{target:"farzher was here (^-^*)/",score:0,_indexes:[0],obj:targets?targets[0]:NULL}]
